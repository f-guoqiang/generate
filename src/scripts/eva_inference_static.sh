...
WORKING_DIR=/mnt/fengguoqiang/ee
...
CKPT_PATH="${WORKING_DIR}/new_data_scale_1103_change_iter/"
...
CMD="python -m torch.distributed.launch --master_port 1234 --nproc_per_node ${NUM_GPUS_PER_WORKER} ${WORKING_DIR}/src/eva_finetune.py ${OPTS}"
